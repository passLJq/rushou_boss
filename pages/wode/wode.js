...
Page({
  ...
  getMsg({
    ...
    if (wx.getStorageSync("SessionUserID")) {
      new Promise((resolve, reject) => {
        util.http({
          url: app.globalData.siteUrl + '/Main/Member/GetMemberJson?devicetype=4',
          data: {
            uid: wx.getStorageSync("SessionUserID")
          },
        ...
        return new Promise((resolve, reject) => {
          if (ret === 1) {
            util.http({
              url: app.globalData.siteUrl + '/Main/Member/GetOrderCountJson?devicetype=4',
              data: {
                uid: wx.getStorageSync("SessionUserID"),
                wxprogram: 2
              },
        ...
        return new Promise((resolve, reject) => {
          if (ret === 1) {
            util.http({
              url: app.globalData.siteUrl + '/Main/Member/GetUserSalesList?devicetype=4',
              data: {
                uid: wx.getStorageSync("SessionUserID")
              },
              loading_icon: loading_icon,
        ...
        return new Promise((resolve, reject) => {
          if (ret === 1) {
            util.http({
              url: app.globalData.siteUrl + '/Main/Member/GetMyTeam?devicetype=4',
              data: {
                uid: wx.getStorageSync("SessionUserID"),
                currentPage: 1,
                pageSize: 1,
          ...
          return new Promise((resolve, reject) => {//优惠券
            if (ret === 1) {
              util.http({
                url: app.globalData.siteUrl + '/Marketing/Coupon/GetUserCouponListJson?devicetype=4',
                data: {
                  uid: wx.getStorageSync("SessionUserID"),
  ...
  onShow: function() {
    ...
    var that=this
    util.http({
      url: app.globalData.siteUrl + '/marketing/redpackage/GetActivityStatus?devicetype=4',
      successBack: (ret) => {
