...
Page({
  ...
  delAdress: function () {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          util.http({
            url: app.globalData.siteUrl + '/Main/Member/DeleteAddress?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
            method: "POST",
            data: {
  ...
  bindAdress: function (flag) {
    let that = this
    util.http({
      url: app.globalData.siteUrl + '/Main/Member/GetOneAddress?devicetype=4',
      data: {
  ...
  saveAdress: function (e) {
    ...
    util.http({
      url: app.globalData.siteUrl + '/Main/Member/InsertorUpdateAddress?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
      method: "POST",
      data: {
        uid: wx.getStorageSync("SessionUserID"),
