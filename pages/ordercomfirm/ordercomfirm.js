...
Page({
  ...
  data: {
    ...
    payid: ['20170824112865489534', '20180929145425946136'],//提交支付时的id
    howmoney: '0.00',//钱包余额
    fxshop: '',
    idcardnum: '',//身份证号码
  ...
  submitOrders(e) {
    ...
    if (this.data.options.way == "shoppingcart") {
      util.http({
        method: "POST",
        url: app.globalData.siteUrl + '/Main/ShoppingSinaPay/PayComfirmOrders?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
        data: {
      ...
      util.http({
        method: "POST",
        url: app.globalData.siteUrl + '/Main/ShoppingSinaPay/PayComfirmPackage?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
        data: {
      ...
      util.http({
        method: "POST",
        url: app.globalData.siteUrl + '/Main/ShoppingSinaPay/PayComfirmOrdersNow?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
        data: {
          memberid: wx.getStorageSync("SessionUserID"),//用户ID
          sourcetype: 0,
          addressid: this.data.addressId,//收货地址ID
  ...
  onLoad: function (options) {
    ...
    if (this.data.options.way == "buynow") {
      ...
      util.http({
        url: app.globalData.siteUrl + '/Main/Shopping/GetCartJson?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
        method: "POST",
        data: {
      ...
      util.http({
        url: app.globalData.siteUrl + '/Main/PackageShopping/GetPackageProJson?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
        method: "POST",
        data: {
  ...
  getAddressMsg() {
    util.http({
      url: app.globalData.siteUrl + '/Main/Shopping/GetAddressJson?devicetype=4', data: {
        uid: wx.getStorageSync('SessionUserID'),
  ...
  gocheackid: function (e) {
    ...
    util.http({
      method: "POST",
      url: app.globalData.siteUrl + '/Main/Member/UserEdit?devicetype=4&uid=' + wx.getStorageSync("SessionUserID"),
      data: {
  ...
  Focus: function (e) {
    ...
    if (e.detail.value.length == 6) {
      util.http({
        url: app.globalData.siteUrl + '/Main/Member/UpdatePayPwd?devicetype=4&uid=' + wx.getStorageSync('SessionUserID'),
        method: 'post',
        data: {
          uid: wx.getStorageSync('SessionUserID'),
