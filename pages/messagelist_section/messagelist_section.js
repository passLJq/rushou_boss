...
databind:function(){
  var that = this
  utils.http({
    url: app.globalData.siteUrl + '/Main/Member/GetMyMessageList?devicetype=4',
    data: {
  ...
  goother: function (e) {
    ...
    utils.http({
      url: app.globalData.siteUrl + '/Main/Member/UpdateMessage?devicetype=4&uid=' + wx.getStorageSync('SessionUserID'),
      method: "post",
      data: {
        uid: wx.getStorageSync('SessionUserID'),
