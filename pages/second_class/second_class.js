...
Page({
  ...
  onShareAppMessage: function() {
    ...
    return {
      title: this.data.listMsg[this.data.slide][0].name,
      path: 'pages/productdetail/productdetail?pid=' + this.data.listMsg[this.data.slide][0].pid + '&ruid=' + ruid,
      imageUrl: this.data.listMsg[this.data.slide][0].pic
    }
  }
})